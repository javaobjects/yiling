        ...
        <div class="search-box mar-t-16">
          <el-row class="box">
            <el-col :span="8">
              ...
              <el-input v-model="query.supplierName" placeholder="请输入内容" />
            </el-col>
...
<script>
import { getErpQueryPurchaseListPage, queryEnterpriseList, getEnterpriseTagList, queryGoodsSpecification } from '@/subject/admin/api/zt_api/erp_flow';
import { erpPurchaseFlowSource } from '@/subject/admin/busi/erp/flowDirection';
