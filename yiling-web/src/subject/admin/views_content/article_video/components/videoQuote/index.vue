      ...
      <div class="pop-up">
        ...
        <div class="table-conter">
          <yl-table
            ...
            :loading="loading"
            @getList="getList">
            <el-table-column align="center" min-width="150" label="视频名称" prop="title"></el-table-column>
            ...
            <el-table-column align="center" min-width="100" label="创建者" prop="createUserName"></el-table-column>
