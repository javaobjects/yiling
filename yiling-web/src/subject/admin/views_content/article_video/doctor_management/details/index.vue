<template>
  <div class="app-container">
          ...
          <el-row :gutter="50">
            <el-col :span="24">
              <el-form-item label="业务引用">
                <business-quote :business-type="businessType" @addBusinessQuote="addBusinessQuote" @addContent="addContent"></business-quote>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
    ...
    <!-- 选择文章弹窗 -->
    <div v-if="showDialog">
      <select-article :show-dialog="showDialog" @addArticle="addArticle" :content-id="form.contentId" @close="close"></select-article>
    </div>
    <!-- 选择视频弹窗 -->
    <div v-if="showVideo">
      <video-quote :show-dialog="showVideo" @addArticle="addArticle" @close="close" :content-id="form.contentId"></video-quote>
    </div>
...
import { doctorContent } from '@/subject/admin/api/content_api/multiterminal';
export default {
  name: 'AddDoctor',
  components: {
  ...
  methods: {
    ...
    // 业务线传递过来的内容权限
    addContent(val) {
      this.contentAuth = val.contentAuth;
    },
    //删除所选文章
