...
<script>
import { lotteryCustomerScopeQueryPromoterPage, lotteryCustomerScopeQueryHadAddPromoterPage, lotteryCustomerScopeAddPromoter, lotteryCustomerScopeDeletePromoter } from '@/subject/admin/api/view_marketing/lottery_activity'
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      let data = await lotteryCustomerScopeQueryPromoterPage(
        goodsQuery.page,
        goodsQuery.limit,
        goodsQuery.eid,
        goodsQuery.ename
    ...
    async getBottomList() {
      ...
      let data = await lotteryCustomerScopeQueryHadAddPromoterPage(
    ...
    async addClick(row) {
      let eidList = []
      eidList.push(row.id)
      let data = await lotteryCustomerScopeAddPromoter(this.lotteryActivityId, 1, eidList)
    ...
    async addSearchClick() {
      ...
      let data = await lotteryCustomerScopeAddPromoter(this.lotteryActivityId, 3, undefined, goodsQuery.eid, goodsQuery.ename)
      if (typeof data !== 'undefined') {
        this.$common.n_success('保存成功');
        this.getBottomList()
      } 
    ...
    async batchAddClick() {
      ...
      let data = await lotteryCustomerScopeAddPromoter(this.lotteryActivityId, 2, eidList)
      if (typeof data !== 'undefined') {
        this.$common.n_success('保存成功');
        this.getBottomList()
      } 
    ...
    async removeClick(row) {
      let ids = []
      ids.push(row.id)
      let data = await lotteryCustomerScopeDeletePromoter(this.lotteryActivityId, 1, ids)
      if (typeof data !== 'undefined') {
        this.$common.n_success('保存成功');
        this.getBottomList()
      } 
    ...
    async deleteSearchClick() {
      ...
      let data = await lotteryCustomerScopeDeletePromoter(this.lotteryActivityId, 3, undefined, bottomGoodsQuery.eid, bottomGoodsQuery.ename)
      if (typeof data !== 'undefined') {
        this.$common.n_success('保存成功');
        this.getBottomList()
      } 
    ...
    async batchRemoveClick() {
      ...
      let data = await lotteryCustomerScopeDeletePromoter(this.lotteryActivityId, 2, ids)
      if (typeof data !== 'undefined') {
        this.$common.n_success('保存成功');
        this.getBottomList()
      } 
