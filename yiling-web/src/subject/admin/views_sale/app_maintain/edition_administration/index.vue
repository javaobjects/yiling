    ...
    <yl-dialog :title="title" @confirm="confirm" width="700px" :visible.sync="showDialog">
      <div class="dialogTc">
        <el-form :model="form" :rules="rules" ref="dataForm1" label-width="150px" class="demo-ruleForm">
          ...
          <!-- <el-form-item label="app下载地址" prop="">
           <el-input v-model="form.appUrl" style="width: 90%" placeholder="请输入地址"
            ></el-input>
          </el-form-item> -->
          <!-- <el-form-item label="schema" prop="schema">
           <el-input v-model="form.schema" style="width: 90%" placeholder="请输入schema"
            ></el-input>
          </el-form-item> -->
...
<script>
import { pageList, listAppInfo, appSave } from '@/subject/admin/api/views_sale/app_maintain';
