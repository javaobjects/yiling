  ...
  <div class="app-container">
    ...
    <div class="app-container-content">
      ...
      <div class="search-bar">
        <yl-table border :show-header="true" :list="dataList" :total="query.total" :page.sync="query.page"
                  :limit.sync="query.limit" :loading="loading" @getList="getList">
      ...
      <div class="dialogTc">
        <el-form :model="form" :rules="rules" ref="dataForm1" label-width="150px" class="demo-ruleForm">
          ...
          <el-form-item label="升级提示语">
            <el-input type="textarea" class="elInput" :rows="2" placeholder="请输入提示语" show-word-limit
                      v-model="form.upgradeTips" maxlength="200"></el-input>
          </el-form-item>
          <el-form-item label="版本描述">
            <el-input type="textarea" class="elInput" :rows="3" placeholder="请输入内容" show-word-limit
...
<script>
  import {pageList, listAppInfo, appSave} from '@/subject/admin/api/b2b_api/version';
