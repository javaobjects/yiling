  ...
  <div class="app-container">
    ...
    <div class="app-container-content">
      ...
      <div class="down-box clearfix">
        <div class="btn">
          <ylButton type="primary" @click="seeClick(1, 0)">创建发放规则</ylButton>
        </div>
      </div>
      <!-- 下部列表 -->
      <div class="search-bar">
        <yl-table 
          ...
          <el-table-column label="规则说明" min-width="120" align="center" prop="description">
          </el-table-column>
...
<script>
import { queryListPage, updateStatus, integralGiveRuleCopy } from '@/subject/admin/api/b2b_api/integral'
...
export default {
  ...
  methods: {
    ...
    async copyClick(val) {
      this.$common.showLoad();
      let data = await integralGiveRuleCopy(
        val
      )
      this.$common.hideLoad();
      if (data !== undefined) {
