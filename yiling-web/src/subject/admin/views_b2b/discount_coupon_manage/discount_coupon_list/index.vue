  ...
  <div class="app-container">
    ...
    <div class="app-container-content">
      ...
      <div class="down-box clearfix">
        <ylButton type="primary" @click="addClick">添加优惠券</ylButton>
        <div class="btn">
          <ylButton type="primary" plain @click="listDownLoadTemp">导出查询结果</ylButton>
          ...
          <el-table-column label-class-name="mar-l-16" label="优惠券信息" min-width="350" align="left">
            <template slot-scope="{ row }">
              <div class="item text-l mar-l-16">
                ...
                <div class="item-text font-size-base font-title-color"><span>优惠券类型：</span>{{ row.type | dictLabel(couponTypeArray) }}</div>
    ...
    <!-- 已发放数量 -->
    <yl-dialog title="已发放优惠券查看" :visible.sync="sendNumDialog" :show-footer="false">
...
import { queryCreatorByNmae, queryActivityEidByName, couponActivityQueryListPage, couponActivityCopy, couponActivityIncrease, couponActivityScrap, couponActivityStop, queryGiveListPage, queryUseListPage } from '@/subject/admin/api/b2b_api/discount_coupon'
...
export default {
  ...
  methods: {
    ...
    eidHandleSelect(item) {
      this.query.availableEid = item.id
    },
    enameHandle() {
      this.query.availableEid = ''
    },
    async getList() {
      this.loading = true
