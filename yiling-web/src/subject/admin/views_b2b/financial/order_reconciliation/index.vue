    ...
    <div class="app-container-content">
      ...
      <div class="mar-t-8 pad-b-10 order-table-view">
        <yl-table
          ...
          <el-table-column label-class-name="mar-l-16" label="基本信息" min-width="320" align="left">
            <template slot-scope="{ row }">
              <div class="item text-l mar-l-16">
                ...
                <div class="item-text font-size-base font-title-color"><span>采购商：</span>{{ row.buyerName }}</div>
                <div class="item-text font-size-base font-title-color"><span>供应商：</span>
                {{ row.sellerName }}
                </div>
              </div>
            </template>
            ...
            <template slot-scope="{ row }">
              <div class="item">
                ...
                <div class="item-text font-size-base font-title-color">
                  <span>货款结算状态：</span>
                  {{ row.goodsStatus | dictLabel(settlementStatus) }}
                </div>
                <div class="item-text font-size-base font-title-color">
                  <span>促销结算状态：</span>
                  {{ row.saleStatus | dictLabel(settlementStatus) }}
                </div>
                <div class="item-text font-size-base font-title-color">
                  <span>预售违约结算状态：</span>
                  {{ row.presaleDefaultStatus | dictLabel(settlementStatus) }}
                </div>
              </div>
            </template>
          </el-table-column>
          <el-table-column label="货款明细" min-width="110" align="left">
            <template slot-scope="{ row }">
              <div class="item">
                <div class="title"></div>
                <div class="item-text font-size-base font-title-color">
          ...
          <el-table-column label="预售违约金额" min-width="110" align="left">
            <template slot-scope="{ row }">
              <div class="item">
                <div class="title"></div>
                <div class="item-text font-size-base font-title-color">
          ...
          <el-table-column label="平台承担金额" min-width="130" align="left">
            <template slot-scope="{ row }">
              <div class="item">
                <div class="title"></div>
                <div class="item-text font-size-base font-title-color">
          ...
          <el-table-column label="总计金额" min-width="130" align="left">
            <template slot-scope="{ row }">
              <div class="item">
                <div class="title"></div>
                <div class="item-text font-size-base font-title-color">
...
import { querySettlementOrderPageList } from '@/subject/admin/api/b2b_api/financial'
import { b2bSettlementStatus } from '@/subject/admin/utils/busi'
export default {
