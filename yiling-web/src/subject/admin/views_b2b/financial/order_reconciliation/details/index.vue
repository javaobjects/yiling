<template>
  <div class="app-container">
    <div class="app-container-content has-bottom-bar">
      ...
      <!-- 下部列表信息 -->
      <div class="mar-t-16 pad-b-30 order-table-view">
        <yl-table
          ref="table"
          ...
          <el-table-column label="平台承担秒杀/特价金额信息" min-width="180" align="left" v-if="!data.presaleDefaultAmount">
              <template slot-scope="{ row }">
                <div class="item">
                  <div class="title"></div>
                  <div class="item-text font-size-base font-title-color">
          ...
          <el-table-column label="平台承担套装金额信息" min-width="180" align="left" v-if="!data.presaleDefaultAmount">
              <template slot-scope="{ row }">
                <div class="item">
                  <div class="title"></div>
                  <div class="item-text font-size-base font-title-color">
          ...
          <el-table-column label="平台承担支付促销金额信息" min-width="200" align="left" v-if="!data.presaleDefaultAmount">
            <template slot-scope="{ row }">
              <div class="item">
                <div class="title"></div>
                <div class="item-text font-size-base font-title-color">
          ...
          <el-table-column label="平台承担预售优惠金额信息" min-width="180" align="left" v-if="!data.presaleDefaultAmount">
              <template slot-scope="{ row }">
                <div class="item">
                  <div class="title"></div>
                  <div class="item-text font-size-base font-title-color">
          ...
          <el-table-column label="小计信息" min-width="140" align="left">
            <template slot-scope="{ row }">
              <div class="item">
                <div class="title"></div>
                <div class="item-text font-size-base font-title-color">
...
<script>
import { querySettlementOrderDetailPageList } from '@/subject/admin/api/b2b_api/financial'
