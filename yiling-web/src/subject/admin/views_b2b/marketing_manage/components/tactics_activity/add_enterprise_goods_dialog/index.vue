...
<script>
import { strategyLimitEnterpriseGoodsList, strategyLimitEnterpriseGoodsPageList, strategyLimitEnterpriseGoodsAdd, strategyLimitEnterpriseGoodsDelete } from '@/subject/admin/api/b2b_api/marketing_manage'
...
export default {
  ...
  methods: {
    ...
    async getBottomList() {
      ...
      let data = await strategyLimitEnterpriseGoodsPageList(
    ...
    async addClick(row) {
      ...
      let data = await strategyLimitEnterpriseGoodsAdd(this.marketingStrategyId, goodsIdList)
    ...
    async addSearchClick() {
      ...
      let data = await strategyLimitEnterpriseGoodsAdd(this.marketingStrategyId, undefined, goodsQuery.goodsName, Number(goodsQuery.goodsId) || '', goodsQuery.ename, goodsQuery.yilingGoodsFlag, goodsQuery.goodsStatus)
      if (typeof data !== 'undefined') {
        this.$common.n_success('保存成功');
        this.getBottomList()
      } 
    ...
    async removeClick(row) {
      ...
      let data = await strategyLimitEnterpriseGoodsDelete(this.marketingStrategyId, ids)
      if (typeof data !== 'undefined') {
        this.$common.n_success('保存成功');
        // 如果当前页数据 全部删除，需要回前一页
    ...
    async deleteSearchClick() {
      ...
      let data = await strategyLimitEnterpriseGoodsDelete(this.marketingStrategyId, undefined, bottomGoodsQuery.goodsName, Number(bottomGoodsQuery.goodsId) || '', bottomGoodsQuery.ename, bottomGoodsQuery.yilingGoodsFlag)
      if (typeof data !== 'undefined') {
        this.$common.n_success('保存成功');
        this.getBottomList()
      } 
