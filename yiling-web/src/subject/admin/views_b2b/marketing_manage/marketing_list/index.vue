  ...
  <div class="app-container">
    ...
    <div class="app-container-content">
      ...
      <div class="down-box clearfix">
        <ylButton type="primary" @click="addClick">创建促销活动</ylButton>
      </div>
      <!-- 底部列表 -->
      <div class="mar-t-8 pad-b-10 order-table-view">
        ...
        >
          ...
          <el-table-column label="上限金额" min-width="120" align="center" prop="budgetAmount">
          </el-table-column>
          ...
          <el-table-column label="操作" min-width="180" align="center" fixed="right">
            <template slot-scope="{ row }">
              <div class="operation-view">
                ...
                <div class="option">
                  <yl-button type="text" :disabled="row.status == 2 || row.status == 3" @click="stopClick(row)">停用</yl-button>
                </div>
              </div>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 活动类型 type: 1-满赠 2-特价 3-秒杀 4-组合包
    addClick() {
      this.$router.push({
        name: 'MarketingEdit',
        params: {
