  ...
  <div class="app-container">
    <div class="app-container-content">
      ...
      <div class="down-box">
        ...
        <div class="btn">
          <el-link class="mar-r-10" type="primary" :underline="false" :href="'NO_6' | template">
            下载模板
          </el-link>
              ...
              <div class="table-view" :key="$index">
                ...
                <div class="content flex-row-left">
                  ...
                  <div class="table-item">
                    ...
                    <div class="item font-size-base font-title-color"><span class="font-light-color">基价：</span>￥{{ row.price }}</div>
                    <div>
    ...
    <!-- 已发放数量 -->
    <yl-dialog title="查看库存信息" :visible.sync="goodsSkuDialog" :show-footer="false">
      <div class="dialog-content-box">
        ...
        <div class="mar-t-10" style="padding-bottom: 10px;background: #FFFFFF;">
          <yl-table border show-header :list="goodsSkuList" :total="0">
            <el-table-column label="ERP内码" min-width="120" align="center" prop="inSn">
            </el-table-column>
            <el-table-column label="ERP编码" min-width="100" align="center" prop="sn">
            </el-table-column>
            <el-table-column label="数量" min-width="100" align="center" prop="packageNumber">
            </el-table-column>
            <el-table-column label="总库存" min-width="120" align="center" prop="qty">
            </el-table-column>
            <el-table-column label="占有库存" min-width="100" align="center" prop="frozenQty">
            </el-table-column>
...
<script>
import { getCompanyProductList, getProductCategory, changeProductInfo } from '@/subject/admin/api/b2b_api/products'
  ...
  methods: {
    ...
    goImport() {
      this.$router.push({
        ...
        query: {
          action: '/b2b/api/v1/b2b/goods/importUpdateGoods'
        }
      })
    },
    // 上下架
