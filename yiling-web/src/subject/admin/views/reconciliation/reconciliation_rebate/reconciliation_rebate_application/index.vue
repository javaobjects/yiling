    ...
    <div class="app-container-content has-bottom-bar">
      ...
      <div class="mar-t-8 pad-b-10 order-table-view">
        <yl-table
          ...
          <el-table-column label="执行部门" min-width="100" align="center" prop="executeDept"></el-table-column>
      ...
      <div class="flex-row-center bottom-view">
        ...
        <!-- <yl-button plain type="primary" v-show="isAudit" @click="auditClick(1)">审核不通过</yl-button>
        <yl-button type="primary" v-show="isAudit" @click="auditClick(2)">审核通过</yl-button> -->
      </div>
    </div>
  </div>
</template>
...
<script>
import { channelType, agreementApplyStatus } from '@/subject/admin/utils/busi';
    ...
    async getList() {
      ...
      if ( this.activeTab == 1){
        data = await queryRebateApplyPageList(
          this.id, query.page, query.limit
        )
      } else {
