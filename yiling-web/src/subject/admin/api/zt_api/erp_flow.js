...
export function getErpQueryGoodsBatchListPage(
  ...
  return request({
    url: '/erp/api/v1/erpFlow/queryGoodsBatchListPage',
    method: 'post',
    data: {
      current,
      size,
...
export function getErpQuerySaleListPage(
  ...
  return request({
    url: '/erp/api/v1/erpFlow/querySaleListPage',
    method: 'post',
    data: {
      current,
      size,
...
export function getErpQueryPurchaseListPage(
  ...
  return request({
    url: '/erp/api/v1/erpFlow/queryPurchaseListPage',
    method: 'post',
    data: {
      current,
      size,
...
export function queryEnterpriseList(ename) {
  return request({
    url: '/erp/api/v1/erpFlow/queryFlowEnterpriseList',
    method: 'post',
    data: {
      ename
    }
...
export function getEnterpriseTagList() {
  return request({
    url: '/erp/api/v1/erpFlow/getEnterpriseTagList',
    method: 'get',
    params: {
    }
  });
...
export function queryGoodsSpecification(key) {
  return request({
    url: '/erp/api/v1/erpFlow/queryGoodsSpecification',
    method: 'get',
    params: {
      key
    }
...
export function getErpqueryShopSaleListPage(
  ...
  return request({
    url: '/erp/api/v1/erpFlow/queryShopSaleListPage',
    method: 'post',
    data: {
      current,
      size,
...
export function queryFlowShopEnterpriseList(name, type) {
  return request({
    url: '/erp/api/v1/erpFlow/queryFlowShopEnterpriseList',
    method: 'post',
    data: {
      name,
      type
