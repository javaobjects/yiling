...
<script>
import { queryActivityDoctorPage, queryVocationalHospitalList, doctorPage, doctorSave, deleteActivityDoctor } from '@/subject/admin/api/cmp_api/goods_promotion'
  ...
  methods: {
    ...
    async exportDoctor() {
      ...
      let data = await createDownLoad({
        className: 'hmcActivityGoodsPromoteDocExportService',
        fileName: '导出活动医生',
        groupName: '导出活动医生',
        menuName: '商品推广销售活动 - 活动医生',
        searchConditionList: [
          {
            desc: '活动id',
            name: 'activityId',
