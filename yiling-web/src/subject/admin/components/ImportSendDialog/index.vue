...
<script>
// 使用示例，接口权限配置 `/system/api/v1/excel/import/${excelCode}/**`
// <import-send-dialog :visible.sync="importSendVisible" :excel-code="info.excelCode" ref="importSendRef"></import-send-dialog>

import { importGetConfig, importDownLoadFile, importPage } from '@/subject/admin/api/common'
import { ylUploadFile } from '@/subject/admin/components'
import { excelExportStatus } from '@/subject/admin/utils/busi'
  ...
  methods: {
    ...
    async getConfig() {
      ...
      if (data) {
        ...
        this.action = `/system/api/v1/excel/import/${data.excelCode}/save`
