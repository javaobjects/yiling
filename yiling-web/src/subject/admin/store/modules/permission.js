import { constantRoutes, endRoutes } from '@/subject/admin/router'
import { getAsyncRoutes } from '@/subject/admin/router/asyncRoute'
import { getUserSideRouter } from '@/subject/admin/api/user'
...
const mutations = {
  SET_ROUTES: (state, routes) => {
    ...
    state.hasDashboard = !!routes.find(item =>
      item.path &&
      (item.path === '/dashboard' || item.path === '/sale_dashboard') &&
