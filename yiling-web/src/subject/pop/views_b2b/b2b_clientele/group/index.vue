  ...
  <div class="app-container">
    ...
    <div class="app-container-content">
      ...
      <div class="down-box clearfix">
        <div class="btn">
          <ylButton v-role-btn="['4']" type="primary" plain @click="addGroupClick">新建分组</ylButton>
        </div>
      </div>
      <!-- 底部列表 -->
      <div
      ...
      >
        ...
        >
          ...
          <el-table-column label="操作" min-width="174" align="center">
            <template slot-scope="{ row }">
              <div>
                <div><yl-button v-role-btn="['1']" type="text" @click="editGroupClick(row)">编辑分组</yl-button></div>
                <div><yl-button v-role-btn="['2']" type="text" @click="groupDeleteClick(row)">删除分组</yl-button></div>
                <div><yl-button v-role-btn="['3']" type="text" @click="groupMoveClick(row)">移动本组客户</yl-button></div>
              </div>
            </template>
          </el-table-column>
        </yl-table>
