          ...
          <el-col :span="8">
            <div class="common-box header-box">
              ...
              <div class="box-text">
                ...
                <div class="item"><span class="font-title-color">单据状态：</span>{{ data.returnStatus | dictLabel(returnStatus) }} <span v-if="data.failReason">({{ data.failReason }})</span></div>
              </div>
            </div>
          </el-col>
          <el-col :span="8">
...
<script>
import { sellerOrderReturnDetail } from '@/subject/pop/api/b2b_api/purchase_order';
...
export default {
  ...
  data() {
    return {
      ...
      navList: [
        ...
        {
          title: '退货单',
          path: '/b2b_purchase_order/b2b_purchase_return_list'
        },
        {
          title: '退货单详情'
        }
  ...
  methods: {
    async getDetail() {
      ...
      let data = await sellerOrderReturnDetail(this.id)
