...
<script>
import { giveQueryEnterpriseListPage, addEnterpriseGiveRecord } from '@/subject/pop/api/b2b_api/discount_coupon'
import { getLocation } from '@/subject/pop/api/common'
import { enterpriseType, enterpriseAuthStatus } from '@/subject/pop/utils/busi'
