    ...
    <div class="app-container-content">
        ...
        <div class="search-box" style="margin-top:0;">
          <el-row class="box">
            ...
            <el-col :span="7">
              ...
              <el-input v-model="query.sellerEname" @keyup.enter.native="searchEnter" placeholder="请输入供应商名称" />
            </el-col>
            <el-col :span="10">
      ...
      <div class="mar-t-8 pad-b-10 order-table-view">
        <yl-table
          ...
          <el-table-column label="供应商名称" min-width="160" align="center" prop="sellerEname">
          </el-table-column>
          ...
          <el-table-column fixed="right" label="下单时间" min-width="120" align="center" >
          ...
          <el-table-column label="发货时间" min-width="120" align="center" >
            <template slot-scope="{ row }">
              <div>
...
import { sellerNamePage } from '@/subject/pop/api/order';
  ...
  methods: {
    ...
    async downLoadTemp() {
      ...
      let data = await createDownLoad({
        className: 'orderFlowSellerExportService',
        fileName: 'string',
        groupName: '流向管理(二级)',
        menuName: '流向管理-药品流向(二级)',
        searchConditionList: [
          {
            desc: '商品名称',
            name: 'goodsName',
