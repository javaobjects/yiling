    ...
    <div class="app-container-content has-bottom-bar">
        ...
        <div class="search-box">
          <el-row class="box">
            ...
            <el-col :span="8">
              ...
              <el-select v-model="query.enterpriseType" placeholder="请选择企业类型">
                <el-option
      ...
      >
        ...
        >
          ...
          <el-table-column label="客户信息" width="592" align="center">
          ...
          <el-table-column label="企业类型" min-width="120" align="center">
            <template slot-scope="{ row }">
              <div>{{ row.customerType }}</div>
            </template>
          </el-table-column>
          <el-table-column label="渠道类型" min-width="174" align="center">
            <template slot-scope="{ row }">
            ...
            <div class="search-box">
              <el-row class="box">
                ...
                <el-col :span="6" :offset="2">
                  <div class="title">渠道类型</div>
                  <el-select v-model="customerQuery.channelId" placeholder="请选择渠道类型">
                    <el-option
                      v-for="item in channelType"
                      v-show="item.value != 1"
                      :key="item.value"
                ...
                <el-col :span="6">
                  <div class="title">企业类型</div>
                  <el-select v-model="customerQuery.enterpriseType" placeholder="请选择企业类型">
                    <el-option
                      v-for="item in enterpriseType"
                      v-show="item.value != 1"
                      :key="item.value"
...
export default {
  ...
  methods: {
    async getList() {
      ...
      let data = await getGrouplcustomerList(
        query.page,
        query.limit,
    ...
    async getCustomerPageListMethod() {
      ...
      let data = await getGrouplcustomerList(
        ...
        customerQuery.channelId,
        customerQuery.enterpriseType
      );
      this.loading1 = false;
