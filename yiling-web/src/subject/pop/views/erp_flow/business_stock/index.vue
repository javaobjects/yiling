    ...
    <div class="app-container-content">
        ...
        <div class="search-box" style="margin-top:0;">
          <el-row class="box">
            <el-col :span="8" class="demo-ruleForm-form">
              ...
              <!-- <el-input v-model="query.bussinessName" placeholder="请输入内容" /> -->
      ...
      <div class="mar-t-8 pad-b-10 order-table-view">
        <yl-table ref="table" :list="dataList" stripe :total="total" :row-class-name="() => 'table-row'" show-header :page.sync="query.page" :limit.sync="query.limit" :loading="loading" :cell-no-pad="true" @getList="getList">
          <el-table-column label-class-name="mar-l-16" label="商品信息" align="left" min-width="220px" fixed="left">
...
<script>
import { getErpQueryGoodsBatchListPage, queryEnterpriseList, getEnterpriseTagList, queryGoodsSpecification } from '@/subject/pop/api/erp_flow';
import { erpGoodsBatchFlowSource } from '@/subject/pop/utils/busi';
  ...
  methods: {
    async getList() {
      ...
      let data = await getErpQueryGoodsBatchListPage(
        query.page,
        query.limit,
        query.bussinessName, //商业名称
        query.productsName, //商品名称
        query.licenseNumber,
        query.manufacturer,
        query.source,
        query.provinceCode,
