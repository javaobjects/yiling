  ...
  <div class="app-container">
    ...
    <div class="app-container-content has-bottom-bar">
      <div class="buy-order-half">
        ...
        <el-row :gutter="8" type="flex">
          <el-col :span="8">
            <div class="common-box header-box">
              ...
              <div class="box-text">
                <div class="item"><span class="font-title-color">商品总总额：</span>{{ data.totalAmount | toThousand('￥') }}</div>
        ...
        <el-row :gutter="8" type="flex" v-if="data.ylflag">
          <el-col :span="8">
            <div class="common-box header-box">
              <div class="header-bar">
          ...
          <el-col :span="8" v-if="currentEnterpriseInfo.channelId == 3">
            <div class="common-box header-box">
              <div class="header-bar">
                <div class="sign"></div>收货回执单
              </div>
              <div class="box-text" v-if="data.receiveReceiptList && data.receiveReceiptList.length">
      ...
      <div class="common-box buy-order-table">
       ...
       <div class="font-title-color font-size-lg mar-l-8 mar-b-16" v-if="data.deliveryType == 2">
        ...
        <div v-if="data.orderStatus === 40 && (currentEnterpriseInfo.channelId == 3 || data.ylflag)">
      ...
      <div class="bottom-bar-view flex-row-center">
        ...
        <yl-button v-if="data.orderStatus === 40" type="primary" @click="receiveThePackage">提交退货</yl-button>
      </div>
    </div>
    <yl-dialog
      title="发票信息"
...
<script>
import { getOrderDetail, uploadReceipt } from '@/subject/pop/api/order'
...
export default {
  ...
  methods: {
    ...
    async onSuccess(data) {
      if (data.length && this.data.id) {
        let keys = data.map(item => {
          return item.key
        })
        this.$common.showLoad()
        let result = await uploadReceipt(this.data.id, keys)
        this.$common.hideLoad()
