          ...
          <el-col :span="16" v-if="data.ylflag">
            <div class="common-box header-box">
              ...
              <div class="box-text">
                ...
                <div class="item"><span class="font-title-color">已开票金额：</span>{{ data.orderInvoiceApplyAllInfo.invoiceFinishAmount | toThousand('￥') }}</div>
                <div class="item"><span class="font-title-color">票折金额：</span>{{ data.ticketDiscountAmount | toThousand('￥') }}</div>
                <yl-table
            ...
            <div class="expand-view" v-for="(item, index) in data.orderDetailDelivery" :key="index">
              ...
              <div class="nums-box" v-if="item.orderDeliveryList && item.orderDeliveryList.length">
                <div
                  ...
                  :key="idx"
                  :class="idx !== (item.orderDeliveryList.length - 1) ? 'mar-b-6' : ''">
                  ...
                  <div class="content-item font-title-color">
                    生产日期：
                    <span class="font-important-color">{{ order.produceDate | formatDate }}</span>
                  </div>
                  <div class="content-item font-title-color">
                    有效期至：
...
<script>
import { getSellOrderDetail, uploadReceipt } from '@/subject/pop/api/order'
  ...
  data() {
    return {
      ...
      navList: [
        ...
        {
          title: '分销销售订单',
          path: '/sell_order/distribute_sale_order'
        },
        {
          title: '分销销售订单详情'
        }
