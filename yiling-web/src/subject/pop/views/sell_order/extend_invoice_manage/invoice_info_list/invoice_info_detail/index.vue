        ...
        <div class="common-box header-box">
          ...
          <div class="box-text">
            ...
            <el-row :gutter="8" type="flex">
              <el-col :span="8">
                <div class="item">
                  <span class="font-title-color">发票申请时间：</span>{{ data.createTime | formatDate }}
                </div>
              </el-col>
              <el-col :span="16">
          ...
          <div class="top-view">
            <div class="my-form-item">
              ...
              <div class="my-form-item-right">{{ ticketDiscountFlag == 1 ? '是' : '否' }}</div>
            </div>
            <div v-show="ticketDiscountFlag">
              <div class="top-view-item mar-b-8" v-for="item in orderTicketDiscountList" :key="item.ticketDiscountNo">
                ...
                <div class="scal-20-width">
                  使用票折金额：<span>￥{{ item.ticketDiscountAmount }}</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="delivery-goods-view" v-for="(item, index) in deliveryItem.applyInvoiceDetailInfo" :key="index">
                  ...
                  <div class="desc-box">
                    ...
                    <div class="right-text box2">
                      <div class="text-item">
                        <span class="font-title-color">商品单价：</span>￥{{ item.goodsPrice }}
                      </div>
                      <div class="text-item">
                        <span class="font-title-color">开票数量：</span>{{ item.invoiceAllQuantity }}
                      </div>
                      <div class="text-item">
                    ...
                    <div class="right-text box3" v-show="ticketDiscountFlag">
                      <div class="text-item">
                        <span class="font-title-color">金额小计：</span>￥{{ item.goodsAmount }}
                      </div>
                      <div class="text-item">
                        <span class="font-title-color">折扣金额：</span>￥{{ item.goodsDiscountAmount }}
                      </div>
                      <div class="text-item">
                        <span class="font-title-color">折扣比率：</span>{{ item.goodsDiscountRate }}%
                      </div>
                    </div>
                  </div>
                  <!-- 批次 -->
                  <div>
                    <el-row class="batch-item" :gutter="8" type="flex" v-for="(batchItem, batchIndex) in item.batchList" :key="batchIndex">
                      ...
                      <el-col :span="6">
                        <div>
                          开票数量：<span class="font-important-color">{{ batchItem.invoiceQuantity }}</span>
                        </div>
                      </el-col>
                    </el-row>
                  </div>
...
<script>
import { getInvoiceApplyDetail } from '@/subject/pop/api/order'
