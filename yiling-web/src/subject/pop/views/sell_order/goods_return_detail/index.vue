  ...
  <div class="app-container">
    ...
    <div class="app-container-content has-bottom-bar">
            ...
            <div class="expand-view" v-for="(item, index) in data.orderDetailVOList" :key="index">
              ...
              <div class="desc-box flex-row-left">
                ...
                <div class="right-text box2">
                  ...
                  <div class="text-item" v-if="data.returnType == 1"><span class="font-title-color">收货数量：</span>{{ item.receiveQuantity }}</div>
                </div>
      ...
      <div class="bottom-bar-view flex-row-center">
        ...
        <yl-button v-role-btn="['2']" type="primary" v-show="data.isAllowCheck == 1" @click="auditClick">审核</yl-button>
      </div>
      <!-- 审核 -->
      <yl-dialog
        title="退货单审核"
    ...
    data() {
      return {
        ...
        navList: [
          ...
          {
            title: '退货单',
            path: '/sell_order/goods_return_list',
