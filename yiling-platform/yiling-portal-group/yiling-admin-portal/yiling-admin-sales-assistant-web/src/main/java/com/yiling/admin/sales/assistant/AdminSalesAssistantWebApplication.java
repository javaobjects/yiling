package com.yiling.admin.sales.assistant;
...
public class AdminSalesAssistantWebApplication {

    public static void main(String[] args) {
        SpringApplication.run(AdminSalesAssistantWebApplication.class, args);
    }
}
