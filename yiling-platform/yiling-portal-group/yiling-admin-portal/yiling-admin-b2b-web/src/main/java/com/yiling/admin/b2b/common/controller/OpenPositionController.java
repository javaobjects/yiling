...
import com.yiling.admin.b2b.common.form.SaveOpenPositionForm;
import com.yiling.admin.b2b.common.form.UpdateOpenPositionStatusForm;
import com.yiling.admin.b2b.common.vo.OpenPositionItemVO;
import com.yiling.admin.b2b.common.vo.OpenPositionVO;
...
public class OpenPositionController extends BaseController {
    ...
    public Result<Page<OpenPositionItemVO>> queryListPage(@CurrentUser CurrentAdminInfo adminInfo, @RequestBody @Valid QueryPageListForm form) {
        ...
        request.setPlatform(OpenPositionPlatformEnum.DYH.getCode());
