...
public class IntegralOrderGiveConfigVO extends BaseVO {
     ...
     * 商家范围：1-全部商家 2-指定商家
     */
    @ApiModelProperty("商家范围：1-全部商家 2-指定商家")
    private Integer merchantScope;

    /**
     * 商品范围：1-全部商品 2-指定平台SKU 3-指定店铺SKU
     */
    @ApiModelProperty("商品范围：1-全部商品 2-指定平台SKU 3-指定店铺SKU")
     ...
     */
    @ApiModelProperty("指定客户范围的企业类型：1-全部类型 2-指定类型")
    private Integer enterpriseType;

    /**
     * 指定客户范围的用户类型：1-全部用户 2-普通用户 3-全部会员 4-部分会员
     */
    @ApiModelProperty("指定客户范围的用户类型：1-全部用户 2-普通用户 3-全部会员 4-部分会员")
    private Integer userType;

    /**
     * 是否区分支付方式：1-全部支付方式 2-指定支付方式
     */
    @ApiModelProperty("是否区分支付方式：1-全部支付方式 2-指定支付方式")
     ...
     */
    @ApiModelProperty("支付方式：1-线上支付 2-线下支付 3-账期支付")
    private List<Integer> paymentMethodList;

    /**
     * 指定商家数量
     */
    @ApiModelProperty("指定商家数量")
    private Integer sellerNum;

    /**
     * 平台SKU数量
     */
    @ApiModelProperty("平台SKU数量")
    private Integer platformGoodsNum;

    /**
     * 指定店铺SKU数量
     */
    @ApiModelProperty("指定店铺SKU数量")
