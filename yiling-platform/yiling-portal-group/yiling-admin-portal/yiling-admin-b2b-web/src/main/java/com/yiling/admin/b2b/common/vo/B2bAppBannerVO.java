...
public class B2bAppBannerVO extends BaseVO {
    ...
    @ApiModelProperty(value = "使用位置：1-B2B移动端主Banner 2-B2B移动端副Banner 3-B2B移动端会员中心Banner 4-B2B移动端店铺Banner")
    ...
    private List<B2bAppBannerEnterpriseVO> bannerEnterpriseList;
}
