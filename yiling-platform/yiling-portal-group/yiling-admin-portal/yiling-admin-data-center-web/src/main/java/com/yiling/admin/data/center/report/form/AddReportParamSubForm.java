...
public class AddReportParamSubForm extends BaseForm {
     ...
     * eid
     */
    @ApiModelProperty(value = "eid--添加会员时必填")
    private Long eid;
     ...
     */
    @Range(min = 1,max = 2)
    @ApiModelProperty(value = "奖励类型：1-金额 2-百分比--添加会员时必填")
    private Integer rewardType;

    /**
     * 奖励类型：1-金额 2-百分比
     */
    @ApiModelProperty(value = "返利金额--添加会员时必填--百分比时传小数如86.3%传86.3")
    private BigDecimal rewardValue;

    /**
     * 数据来源：1-B2B-自然流量 2-B2B-企业推广 3-销售助手
     */
    @ApiModelProperty(value = "数据来源--添加会员时必填--数据来源：1-B2B-自然流量 2-B2B-企业推广 3-销售助手")
     ...
     * 开始时间
     */
    @ApiModelProperty(value = "开始时间--添加会员时必填")
    private Date startTime;

    /**
     * 结束时间
     */
    @ApiModelProperty(value = "结束时间--添加会员时必填")
