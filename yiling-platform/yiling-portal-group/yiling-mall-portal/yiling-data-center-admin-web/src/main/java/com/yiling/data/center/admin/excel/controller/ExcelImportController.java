package com.yiling.data.center.admin.excel.controller;
...
import com.yiling.data.center.admin.excel.form.QueryExcelTaskRecordPageListForm;
import com.yiling.data.center.admin.excel.vo.ExcelTaskConfigVO;
import com.yiling.data.center.admin.excel.vo.ExcelTaskRecordVO;
...
public class ExcelImportController extends BaseController {
    ...
    public Result<Page<ExcelTaskRecordVO>> page(@PathVariable("excelCode") String excelCode, @RequestBody @Valid QueryExcelTaskRecordPageListForm form, @CurrentUser CurrentStaffInfo staffInfo) {
    ...
    public Result<UrlObject> downloadFile(@PathVariable("excelCode") String excelCode, @PathVariable("id") Long id, @CurrentUser CurrentStaffInfo staffInfo) {
    ...
    public Result<ExcelTaskConfigVO> get(@PathVariable("excelCode") String excelCode, @CurrentUser CurrentStaffInfo staffInfo) {
        ExcelTaskConfigDTO excelTaskConfigDTO = excelTaskConfigApi.findExcelTaskConfigByCode(excelCode);
    ...
    public Result<Boolean> save(@RequestParam(value = "file", required = true) MultipartFile file, @PathVariable("excelCode") String excelCode, @CurrentUser CurrentStaffInfo staffInfo) {
        ExcelTaskConfigDTO excelTaskConfigDTO = excelTaskConfigApi.findExcelTaskConfigByCode(excelCode);
        ...
        recordRequest.setEid(staffInfo.getCurrentEid());
        ...
        recordRequest.setSource(ExcelSourceEnum.BUSINESS.getCode());
