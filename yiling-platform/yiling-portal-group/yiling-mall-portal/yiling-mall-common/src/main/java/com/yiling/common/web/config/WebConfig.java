...
import com.yiling.common.web.interceptor.UserAccessAuthenticationInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Bean
    public UserAccessAuthenticationInterceptor userAccessAuthenticationInterceptor() {
        return new UserAccessAuthenticationInterceptor();
    }
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        // token拦截配置
        registry.addInterceptor(this.userAccessAuthenticationInterceptor())
                .addPathPatterns("/**")
                .excludePathPatterns(apiDocExcludePathPatterns);
    }
