...
public class OrderEnterprisePageVO extends BaseVO {
    /**
     * 订单号
     */
     ...
     * 买家企业省份名称
     */
    @ApiModelProperty(value = "买家企业省份名称")
    private String buyerProvinceName;

    /**
     * 买家企业城市名称
     */
    @ApiModelProperty(value = "买家企业城市名称")
    private String buyerCityName;

    /**
     * 买家企业去名称
     */
    @ApiModelProperty(value = "买家企业去名称")
    private String buyerRegionName;

    /**
     * 卖家企业省份名称
     */
    @ApiModelProperty(value = "卖家企业省份名称")
    private String sellerProvinceName;

    /**
     * 卖家企业城市名称
     */
    @ApiModelProperty(value = "卖家企业城市名称")
    private String sellerCityName;

    /**
     * 卖家企业区名称
     */
    @ApiModelProperty(value = "卖家企业区名称")
