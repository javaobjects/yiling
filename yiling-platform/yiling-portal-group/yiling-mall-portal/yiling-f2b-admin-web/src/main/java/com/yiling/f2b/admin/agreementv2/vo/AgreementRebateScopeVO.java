...
public class AgreementRebateScopeVO extends BaseVO {
    ...
    private AgreementRebateControlAreaVO agreementRebateControlArea;
    ...
    private List<AgreementRebateTaskStageVO> agreementRebateTaskStageList;
