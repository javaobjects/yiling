...
public class AddAgreementRebateTermsForm extends BaseForm {
    ...
    @NotNull
    @Range(min = 0, max = 1)
    @ApiModelProperty(value = "是否底价供货：0-否 1-是",required = true)
     ...
     */
    @Range(min = 0, max = 1)
    @ApiModelProperty(value = "商品返利规则设置方式：1-全品设置 2-分类设置",required = true)
     ...
     */
    @Range(min = 0, max = 1)
    @ApiModelProperty(value = "是否有任务量：0-否 1-是",required = true)
     ...
     */
    @Range(min = 1, max = 3)
    @ApiModelProperty(value = "返利标准：1-销售 2-购进 3-付款金额（见字典：agreement_rebate_task_standard）",required = true)
     ...
     */
    @Range(min = 1, max = 3)
    @ApiModelProperty(value = "返利计算单价：1-销售 2-购进 3-付款金额（见字典：agreement_rebate_task_standard）",required = true)
     ...
     */
    @Range(min = 1, max = 2)
    @ApiModelProperty(value = "返利阶梯条件计算方法：1-覆盖计算 2-叠加计算（见字典：agreement_rebate_stage_method）",required = true)
     ...
     */
    @Range(min = 1, max = 2)
    @ApiModelProperty(value = "返利计算规则：1-按单计算 2-汇总计算（见字典：agreement_rebate_calculate_rule）",required = true)
     ...
     */
    @Range(min = 1, max = 2)
    @ApiModelProperty(value = "返利计算规则类型：1-起返 2-倍返（见字典：agreement_rebate_rule_type）",required = true)
     ...
     * 协议返利支付方指定商业公司集合
     */
    @ApiModelProperty("协议返利支付方指定商业公司集合（选择指定商业公司时，才需要此集合传值）")
    private List<AddAgreementRebatePayEnterpriseForm> agreementRebatePayEnterpriseList;

    /**
     * 非商品返利集合（最多6个阶梯）
     */
    @ApiModelProperty("非商品返利集合（最多6个阶梯）")
    private List<AddAgreementOtherRebateForm> agreementOtherRebateList;

    /**
     * 协议返利时段集合
     */
    @ApiModelProperty("协议返利时段集合")
    private List<AddAgreementRebateTimeSegmentForm> agreementRebateTimeSegmentList;
