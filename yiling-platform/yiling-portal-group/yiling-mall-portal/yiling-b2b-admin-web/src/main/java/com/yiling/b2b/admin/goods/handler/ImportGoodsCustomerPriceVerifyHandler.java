 ...
 */
@Component
public class ImportGoodsCustomerPriceVerifyHandler implements IExcelVerifyHandler<ImportGoodsCustomerPriceForm> {
    ...
    @Override
    public ExcelVerifyHandlerResult verifyHandler(ImportGoodsCustomerPriceForm obj) {
