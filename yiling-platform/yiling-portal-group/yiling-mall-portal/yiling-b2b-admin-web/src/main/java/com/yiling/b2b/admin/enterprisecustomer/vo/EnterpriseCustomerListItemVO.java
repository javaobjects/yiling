...
public class EnterpriseCustomerListItemVO extends BaseVO {
    ...
    @ApiModelProperty(value = "是否被占有")
    private CustomerDisableVO customerDisableVO;

    /**
     * 是否已开通线下支付（批量开通线下支付列表页使用）
     */
    @ApiModelProperty("是否已开通线下支付")
    private Boolean openOfflineFlag;
