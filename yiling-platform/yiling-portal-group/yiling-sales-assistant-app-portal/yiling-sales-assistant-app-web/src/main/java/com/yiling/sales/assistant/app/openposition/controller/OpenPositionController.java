package com.yiling.sales.assistant.app.openposition.controller;
...
import com.yiling.sales.assistant.app.openposition.vo.OpenPositionVO;
...
public class OpenPositionController extends BaseController {
    ...
    public Result<OpenPositionVO> get(@CurrentUser CurrentStaffInfo staffInfo) {
        OpenPositionDTO openPositionDTO = openPositionApi.getOpenPositionPicture(OpenPositionPlatformEnum.SA.getCode());
