package com.yiling.erp.client.websocket;
    ...
    public void onOpen(Session session) {
        ...
        new Thread(() -> {
            ...
            while (sessionMap.get(session.getId()) != null) {
                ...
                try {
                    //日志文件路径，获取最新的
//                    String filePath = System.getProperty("catalina.base") + "/logs/erpLog.log";
//                    String filePath = "D:/Java/apache-tomcat-8.5.70" + "/logs/catalina.out";
                    String filePath = InitErpConfig.LOG_PATH;
