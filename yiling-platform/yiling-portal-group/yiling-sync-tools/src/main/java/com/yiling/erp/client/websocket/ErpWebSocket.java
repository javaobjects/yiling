...
public class ErpWebSocket {
    ...
    private static CopyOnWriteArraySet<ErpWebSocket> webSocketSet = new CopyOnWriteArraySet<ErpWebSocket>();
    ...
    public void onMessage(String message, Session session) {
        ...
        //群发消息
        for (ErpWebSocket item : webSocketSet) {
            try {
