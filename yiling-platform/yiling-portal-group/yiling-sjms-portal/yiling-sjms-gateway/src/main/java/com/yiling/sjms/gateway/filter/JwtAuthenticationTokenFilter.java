...
import com.yiling.sjms.gateway.config.CommonUrlsConfig;
import com.yiling.sjms.gateway.config.IgnoreUrlsConfig;
...
public class JwtAuthenticationTokenFilter implements GlobalFilter, Ordered {
    ...
    private boolean verifyRequestUrl(Long userId, String requestUrl) {
        ...
        List<MenuDTO> userMenus = menuApi.listMenusByUser(PermissionAppEnum.SJMS, MenuTypeEnum.all(), 0L, userId);
        // 获取配置了url的菜单和按钮
