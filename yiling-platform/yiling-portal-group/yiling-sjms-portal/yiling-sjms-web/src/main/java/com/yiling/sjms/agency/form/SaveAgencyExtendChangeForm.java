 ...
 */
@Data
public class SaveAgencyExtendChangeForm extends BaseForm {
    private Long id;
    /**
     * 主表主键
     */
     ...
     * 变更项目
     */
    @ApiModelProperty(value = "变更项目 字典 1.商业公司crm_agency_distributor_change_item 2.医疗机构crm_agency_hospital_change_item 3.零售机构crm_agency_pharmacy_change_item  多个用,号分隔 ")
    @NotEmpty
