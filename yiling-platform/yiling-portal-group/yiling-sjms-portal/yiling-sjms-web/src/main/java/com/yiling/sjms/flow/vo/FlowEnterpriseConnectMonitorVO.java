...
/**
 * @author shichen
 * @类名 FlowEnterpriseConnectMonitorVO
 * @描述
 * @创建时间 2023/3/27
 * @修改人 shichen
 * @修改时间 2023/3/27
...
public class FlowEnterpriseConnectMonitorVO extends BaseVO {
    /**
     * erp客户端id
     */
    @ApiModelProperty(value = "erp客户端id")
     ...
     * 所属省份编码
     */
    @ApiModelProperty(value = "经销商省份编码")
    private String provinceCode;

    /**
     * 所属省份名称
     */
    @ApiModelProperty(value = "经销商省份名称")
    private String provinceName;

    /**
     * 对接级别 1一级经销商、2二级经销商、3准一级经销商、4连锁商业、5云仓商业、6未分级经销商
     */
    @ApiModelProperty(value = "经销商级别 1一级经销商、2二级经销商、3准一级经销商、4连锁商业、5云仓商业、6未分级经销商")
     ...
     */
    @ApiModelProperty(value = "流向收集方式：1-工具 2-ftp 3-第三方接口 4-以岭平台接口")
     ...
     * 回传流向天数计数
     */
    @ApiModelProperty(value = "回传流向天数计数")
