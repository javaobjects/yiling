...
public class SaleAppealSelectFlowFormVO extends BaseVO {
    /**
     * 主流程表单id
     */
     ...
     * 经销商名称编码
     */
    @ApiModelProperty("经销商名称编码")
    private Long crmId;

    /**
     * 经销商名称（商家名称）
     */
    @ApiModelProperty("经销商名称（商家名称）")
    private String ename;

    /**
     * 客户供应链角色：1-经销商 2-终端医院 3-终端药店。数据字典：erp_crm_supply_chain_role
     */
    @ApiModelProperty("客户供应链角色：1-经销商 2-终端医院 3-终端药店。数据字典：erp_crm_supply_chain_role")
    private Integer customerSupplyChainRole;

    /**
     * 产品品名编码
     */
    @ApiModelProperty("产品品名编码")
     ...
     * 产品品规
     */
    @ApiModelProperty("产品品规")
    private String goodsSpec;

    /**
     * 数量（最终数量）
     */
    @ApiModelProperty("数量（最终数量）")
    private BigDecimal finalQuantity;
    /**
     * 单位（原始单位）
     */
    @ApiModelProperty("单位（原始单位）")
     ...
     */
    @ApiModelProperty("根据申诉类型变化的变化类型：1、标准机构名称 2、标准产品名称 3、机构属性")
