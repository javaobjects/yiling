...
@Slf4j
@RestController
@RequestMapping(value = "/flow/collect/summary")
@Api(tags = "日流向未上传统计")
public class FlowDaySummaryStatisticsController {
    ...
    public Result<FlowDayStatisticsTableVO> list(@CurrentUser CurrentSjmsUserInfo userInfo, @RequestBody QueryDayCollectStatisticsForm form) {
        ...
        //固定经销商信息
        Page<FlowDayHeartStatisticsBO> page = flowCollectSummaryStatisticsApi.page(request);
        //处理人员姓名
