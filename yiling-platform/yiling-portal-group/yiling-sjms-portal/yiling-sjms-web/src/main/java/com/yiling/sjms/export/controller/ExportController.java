package com.yiling.sjms.export.controller;
...
import com.yiling.sjms.export.form.QueryExportPageListForm;
import com.yiling.sjms.export.form.SaveExportSearchConditionForm;
import com.yiling.sjms.export.form.SaveExportTaskForm;
import com.yiling.sjms.export.vo.ExportTaskRecordVO;
...
public class ExportController extends BaseController {
    ...
    public Result<UrlObject> downloadFile(@RequestParam @ApiParam(name = "taskId", value = "任务ID号", required = true) Long taskId
            , @CurrentUser CurrentSjmsUserInfo adminInfo) {
    ...
    public Result<Boolean> export(@RequestBody @Valid SaveExportTaskForm form
            , @CurrentUser CurrentSjmsUserInfo adminInfo) {

        SaveExportSearchConditionForm conditionForm=new SaveExportSearchConditionForm();
        conditionForm.setDesc("用户工号");
        conditionForm.setName("currentUserCode");
        conditionForm.setValue(String.valueOf(adminInfo.getCurrentUserCode()));
        ...
        conditionUserForm.setValue(String.valueOf(adminInfo.getCurrentUserId()));
