 ...
 */
@Data
public class SaleTargetLastCalForm extends BaseForm {
    List<SaleTargetDepartmentLastCalForm> list;
    ...
    public BigDecimal getLastTargetSum() {
        return lastTargetSum==null?BigDecimal.ZERO:lastTargetSum.setScale(0);
    }
