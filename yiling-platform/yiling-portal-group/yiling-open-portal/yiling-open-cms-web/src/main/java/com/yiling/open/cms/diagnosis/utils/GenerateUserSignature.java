package com.yiling.open.cms.diagnosis.utils;


import cn.hutool.json.JSONException;
import cn.hutool.json.JSONObject;
import com.yiling.open.erp.util.Base64;
...
public class GenerateUserSignature {
    ...
    public static void main(String[] args) {
        String s = GenTLSSignature(1400318040, "123", EXPIRETIME, null, "d846b35508243541af1ffbea4019346f4687bb3ad6f51fbebbfd18927bbb8176");
    ...
    public static String GenTLSSignature(long sdkappid, String userId, long expire, byte[] userbuf, String priKeyContent) {
        ...
        if (null != userbuf) {
            base64UserBuf = Base64.encodeToString(userbuf, false);
            try {
    ...
    private static String hmacsha256(long sdkappid, String userId, long currTime, long expire, String priKeyContent, String base64Userbuf) {
        ...
        try {
            ...
            return Base64.encodeToString(byteSig, false);
    ...
    private static byte[] base64EncodeUrl(byte[] input) {
        byte[] base64 = Base64.encodeToString(input, false).getBytes();
