...
public interface WxConstant {
     ...
     * 事件类型：点击菜单跳转链接时的事件推送
     */
    String EVENT_TYPE_VIEW_MINIPROGRAM = "VIEW_MINIPROGRAM";
    ...
    /**
     * 发送模板信息接口， post 请求。%s 为要填入的参数<br>
     */
    String URL_TEMPLATE_SEND_POST = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=%s";

    /**
     * 创建小程序码， post 请求。%s 为要填入的参数<br>
     */
    String URL_CREATE_WX_QR_CODE_POST = "https://api.weixin.qq.com/cgi-bin/wxaapp/createwxaqrcode?access_token=%s";

    /**
     * 获取小程序码， post 请求。%s 为要填入的参数<br>
     * 通过该接口生成的小程序码，永久有效，有数量限制
     */
    String URL_GET_WX_QR_CODE_POST = "https://api.weixin.qq.com/wxa/getwxacode?access_token=%s";

    /**
     * 获取小程序码， post 请求。%s 为要填入的参数<br>
     * 通过该接口生成的小程序码，永久有效，数量暂无限制
     */
    String GET_WX_A_CODE_UN_LIMIT_URL = "https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token=%s";

    /**
     * 取药提醒模板id-公众号
     */
    String TEMPLATE_ID_MEDICINE_REMINDER = "Bkg65sQ8NZyu21s4stzS9CpCR2J3VQebfSe3CKVfFu0";

    /**
     * 微信小程序消息订阅事件
     */
    String SUBSCRIBE_MSG_POPUP_EVENT = "subscribe_msg_popup_event";

    /**
     * 修改订阅事件
     */
    String SUBSCRIBE_MSG_CHANGE_EVENT = "subscribe_msg_change_event";
}
