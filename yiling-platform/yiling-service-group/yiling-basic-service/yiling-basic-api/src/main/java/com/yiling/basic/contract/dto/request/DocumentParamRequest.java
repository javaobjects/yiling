...
public class DocumentParamRequest extends BaseRequest {
     ...
     * 处方药成长品销售目标表
     */
    private List<GrowUpRequest> growUpTable;

    /**
     * 服务费用奖励标准和推荐级别表
     */
    private List<IncentiveStandardRequest> incentiveStandardTable;
}
