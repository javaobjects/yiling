 ...
 */
@Slf4j
@RocketMqListener(topic = Constants.TOPIC_SUPPLIER_MAPPING_MONTH_WASH, consumerGroup = Constants.TAG_SUPPLIER_MAPPING_MONTH_WASH)
public class FlowSupplierMappingListener extends AbstractMessageListener {
    ...
    protected MqAction consume(String body, MessageExt message, ConsumeConcurrentlyContext context) {
        ...
        List<FlowEnterpriseSupplierMappingDTO> mappingList = JSON.parseArray(msg, FlowEnterpriseSupplierMappingDTO.class);
        //刷新月流向
        flowMonthWashTaskService.updateMonthFlowBySupplierMapping(mappingList);
        //刷新日流向
        flowMonthWashTaskService.updateDayFlowBySupplierMapping(mappingList);
