 ...
 */
@Slf4j
@RocketMqListener(topic = Constants.TOPIC_UNLOCK_CUSTOMER_CLASSIFICATION_TASK, consumerGroup = Constants.TAG_UNLOCK_CUSTOMER_CLASSIFICATION_TASK,maxThread = 3)
public class UnlockCustomerClassMappingListener extends AbstractMessageListener {
    ...
    protected MqAction consume(String body, MessageExt message, ConsumeConcurrentlyContext context) {
        ...
        Long ufwtId = Long.parseLong(msg);

        unlockCustomerClassDetailService.unlockCustomerClassMappingHandle(ufwtId);
