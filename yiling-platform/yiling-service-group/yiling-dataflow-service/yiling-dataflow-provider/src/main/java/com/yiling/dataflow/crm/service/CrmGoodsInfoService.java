 ...
 * @date 2022-11-03
 */
public interface CrmGoodsInfoService extends BaseService<CrmGoodsInfoDO> {

    List<CrmGoodsInfoDTO> getCrmGoodsInfoAll();

    CrmGoodsInfoDTO getCrmGoodsInfoByCode(Long code);

    /**
     * 商品code或者（商品code和商品名称）查询crmgoods
     * @param goodsCode 精准查询条件
    ...
    /**
     * 模糊查询crmgoods
     * @param goodsName 模糊查询条件
     * @param goodsSpec 模糊查询条件
     * @param limit 查询条数
     * @return
     */
