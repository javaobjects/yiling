 ...
 */
@Slf4j
@RocketMqListener(topic = Constants.TOPIC_UNLOCK_CUSTOMER_MATCHING_RATE_TASK, consumerGroup = Constants.TAG_UNLOCK_CUSTOMER_MATCHING_RATE_TASK,maxThread = 3)
public class UnlockCustomerMatchingRateListener extends AbstractMessageListener {
