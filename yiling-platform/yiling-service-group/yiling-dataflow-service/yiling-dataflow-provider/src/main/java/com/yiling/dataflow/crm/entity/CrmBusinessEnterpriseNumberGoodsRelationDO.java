...
@TableName("crm_business_enterprise_number_goods_relation")
public class CrmBusinessEnterpriseNumberGoodsRelationDO extends BaseDO {
     ...
     * 普药类型
     */
    private String generalMedicineType;
