...
public class AgreementRebateTermsBO extends BaseVO implements Serializable {
    ...
    private List<AgreementRebatePayEnterpriseBO> agreementRebatePayEnterpriseList;

    /**
     * 非商品返利集合（最多6个阶梯）
     */
    @ApiModelProperty("非商品返利集合（最多6个阶梯）")
    private List<AgreementOtherRebateBO> agreementOtherRebateList;

    /**
     * 协议返利时段集合
     */
    @ApiModelProperty("协议返利时段集合")
    private List<AgreementRebateTimeSegmentBO> agreementRebateTimeSegmentList;
