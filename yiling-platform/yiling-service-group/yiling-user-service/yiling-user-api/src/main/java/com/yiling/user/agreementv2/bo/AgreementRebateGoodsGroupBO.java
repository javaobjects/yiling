...
public class AgreementRebateGoodsGroupBO extends BaseVO implements Serializable {
    ...
    private List<AgreementRebateGoodsBO> agreementRebateGoodsList;

    /**
     * 协议返利范围集合
     */
    @ApiModelProperty("协议返利范围集合")
    private List<AgreementRebateScopeBO> agreementRebateScopeList;
