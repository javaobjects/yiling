...
public class AgreementSupplySalesGoodsGroupBO extends BaseVO implements Serializable {
    ...
    private List<AgreementSupplySalesGoodsProBO> supplySalesGoodsList;
    ...
    private AgreementControlAreaBO controlArea;
