...
public enum NoEnum {
     ...
     * 团购流程单号
     */
    GB_NO("TG", MiddelPartMode.DATESTR, 2),

    EXTEND_INFO_CHANGE("TZXXXG",MiddelPartMode.DATESTR,2),

    ENTERPRISE_ADD_NO("EA", MiddelPartMode.DATESTR, 2),

    ENTERPRISE_UPDATE_NO("EU", MiddelPartMode.DATESTR, 2),

    ENTERPRISE_UNLOCK_NO("RSC", MiddelPartMode.DATESTR, 2),
