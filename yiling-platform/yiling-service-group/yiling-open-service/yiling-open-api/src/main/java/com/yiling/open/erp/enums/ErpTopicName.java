...
public enum ErpTopicName {
    ...
    ErpOrderErpSn("20000003","erp_order_erpsn","","订单回写第三方订单号"),
    ...
    ErpOrderPurchaseDelivery("20000018","erp_order_purchase_delivery","delivery_no","采购入库单同步"),

    ErpOrderPurchaseNo("20000019","erp_order_purchase_no","","流向采购单单号回写"),
    ErpOrderSaleNo("20000020","erp_order_sale_no","","流向销售单单号回写"),
    ...
    fineHttpRequest("30000020","fine_http_request","","帆软工具请求接口"),
    ...
    ErpShopSaleFlow("40000012","erp_shop_sale_flow","","连锁门店销售流向"),
    ErpShopSaleFlowData("40000013","erp_shop_sale_flow_interface","","连锁门店销售流向接口同步"),
