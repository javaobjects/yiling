 ...
 */
@Data
public class ErpOrderDetailDTO implements java.io.Serializable {
     ...
     * 订单编号
     */
    @JSONField(name = "third_code", ordinal = 5)
     ...
     * 客户内码
     */
    @JSONField(name = "enterprise_inner_code", ordinal = 5)
     ...
     * 商品实付单价
     */
    @JSONField(name = "truth_price", ordinal = 5)
