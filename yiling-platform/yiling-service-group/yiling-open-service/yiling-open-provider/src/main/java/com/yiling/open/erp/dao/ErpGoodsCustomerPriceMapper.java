 ...
 */
@Repository
public interface ErpGoodsCustomerPriceMapper extends ErpEntityMapper, BaseMapper<ErpGoodsCustomerPriceDO> {
     ...
     * @return
     */
    List<ErpGoodsCustomerPriceDO> syncGoodsCustomerPrice();
     ...
     * @return
     */
    List<ErpGoodsCustomerPriceDO> getGoodsCustomerPriceBySuId(@Param("suId") Long suId);


    List<ErpGoodsCustomerPriceDO> findBySyncStatusAndInSnList(@Param("list") List<String> list,
