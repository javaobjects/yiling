 ...
 */
@Slf4j
@RocketMqListener(topic = "erp_flow_sealed_unLock_purchase", consumerGroup = "erp_flow_sealed_unLock_purchase")
public class ErpFlowSealedUnLockPurchaseMqListener implements MessageListener {
    ...
    public MqAction consume(MessageExt message, ConsumeConcurrentlyContext context) {
        ...
        try {
            ...
            erpPurchaseFlowHandler.handleUnLockPurchaseFlowMqSync(Long.parseLong(message.getTags()), msg);
        } catch (Exception e) {
